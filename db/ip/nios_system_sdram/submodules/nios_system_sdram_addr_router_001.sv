...
(
    ...
    localparam PAD15 = log2ceil(64'h2020 - 64'h2010); 
    localparam PAD16 = log2ceil(64'h2028 - 64'h2020); 
    ...
    // ( 0x1800 .. 0x2000 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 27'h1800   ) begin
            src_channel = 18'b000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x2000 .. 0x2010 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 27'h2000   ) begin
            src_channel = 18'b000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 17;
    end

    // ( 0x2010 .. 0x2020 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 27'h2010   ) begin
            src_channel = 18'b000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x2020 .. 0x2028 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 27'h2020   ) begin
